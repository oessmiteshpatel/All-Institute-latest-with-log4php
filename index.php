								...
								<div class="navbar-header">
									...
									<div class="navbar-collapse collapse">
										<ul class="nav navbar-nav">
											<li id="menu-item-75" class="mega menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-75 active"><a href="index.php" class="">Home</a>
											</li>
				...
				<div id="main" class="m-all t-all d-all cf" role="main">
					<div class="section-white page-slider home-page-slider bg_img  hom banner_height">
						<div class="arrow-down animated pulse infinite" data-wow-delay="500">
							<div class="icon-arrow"><i class="fa fa-angle-down"></i>
							</div>
						</div>
					</div>

					<div id="ALLInstitute">
						<article class="cf container post-2 page type-page status-publish hentry" role="article" itemscope itemtype="#">
							<div class="row">
							<header class="article-header padding-service">
								<h1 class="wow fadeInUp red_font">Applied Lifelong Learning Institute</h1>
							</header>
							<section class="entry-content cf" itemprop="articleBody">

								<div class="homepage-article scrolled accounting wow fadeInUp panel section-blue panel-default">
									<div class="article-image m-all t-3of5 image-center padding75em"> <img width="680" height="340" src="image/image1.jpg" class="attachment-bones-thumb-600 wp-post-image" alt="profile_0006_dip account"/> </div>
									<div class="article-content m-all col-md-12">

										<div class="byline vcard ">&nbsp; </div>
										<div class="paragraph-content">
											<p>Welcome to the <span class="fontcolor">Applied Lifelong Learning Institute (ALL-Institute)</span>. Our philosophy is very simple, we will provide a learning opportunity that is engaging, meaningful, and aligned to real-world work situations across the career lifespan. Our chief complaint with employers who we develop learning and assessment solutions is that their current solutions don't resemble the real world. So, like our eLearning, training, and assessment solutions, the ALL-Institute develops a curriculum and learning experience that is applied, real-world, problem-based, and represents the needs of the employers and ultimately helps the learner succeed.
											</p>
											<div class="center txtcenter"><a href="allcourses.php" class="button btn-red btn-purple">Course Offerings</a> </div>
										</div>
									</div>
									<div class="clearfix"></div>
								</div>
